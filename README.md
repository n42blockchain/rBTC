...
1,008-block commit. The Taproot soak therefore uses 1,008 blocks despite its
larger atomic tail.
...
retained path uses one auxiliary 128-block window, bounded primary remainder
windows, the two-second slow-auxiliary guard, and at most three ready
replacement candidates. Expanding that pool to eight was also rejected after
