...
| Competing headers | Active-only serving and rollback-safe durable eviction primitives exist. Automatic peer/local ingress retention and safe reacquisition of an evicted stronger fork remain open. |
