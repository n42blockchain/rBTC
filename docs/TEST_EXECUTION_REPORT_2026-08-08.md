...
4. `RBTC_TOR_CONTROL=127.0.0.1:9051 RBTC_TOR_COOKIE=/tmp/rbtc-nettest/tor/data/control_auth_cookie RBTC_TOR_SOCKS=127.0.0.1:9050 RBTC_I2P_SAM=127.0.0.1:7656 cargo test --release --all-features --test anonymity_network_interop -- --ignored --nocapture`
...
Overall result: 真实拨号级场景尚未通过（2 项失败），继续建议优先排查 i2pd 与 SAM 会话建立的握手稳定性。
