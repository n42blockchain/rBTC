...
最新进展见 [MAC_FOLLOWUP_2026-09-13.md](MAC_FOLLOWUP_2026-09-13.md)：
①加入预算化完整搜索和旧顺序复用，②加入共享准入延期账本，③加入显式原子淘汰和
重开预检基础；六项仍未全关。Mac 的 160M / 900k 双通道已完成，RSS 比 1.123；
紧容量维护补测比值 3.371，仍需审查。Linux 地址已明确为 `n42@192.168.0.166`，
[Linux 后续](LINUX_ACCEPTANCE_2026-09-13.md)已确认 SSH 正常、960 项回归通过，并完成
快照复制、承诺验证和索引重建；仍缺连续区块。下面“未连接 Mac”和“未完成矩阵”等表述是历史记录。
原始 Mac 兼容性修复见 [MAC_ACCEPTANCE_2026-09-12.md](MAC_ACCEPTANCE_2026-09-12.md)。
