...
后续 Mac 实跑与修复见 [MAC_ACCEPTANCE_2026-09-12.md](MAC_ACCEPTANCE_2026-09-12.md)：
M1 Max / 64 GiB 的完整规模容量预检通过，943 项本地回归和 13 项实时 Core 对照通过，
完整存储任务已启动但尚无完成矩阵。本文下面的“未连接 Mac”是此前 Linux 会话的历史记录。
