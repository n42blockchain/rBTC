...
mod tests {
    ...
    fn validation_delta_encoding_is_canonical_and_strict() {
        ...
        // Immutable persisted-format fixture. In particular, this pins the
        // bloom checksum bytes across `sha2` major-version upgrades instead of
        // only checking encode/decode against the same implementation.
        let fixture = encode_validation_bloom(
            &ValidationBloom {
                bits: vec![0x00, 0x01, 0x7f, 0x80, 0xff],
            },
        ...
        assert_eq!(
            fixture,
            vec![
                0x52, 0x56, 0x42, 0x31, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01, 0x05, 0x00,
                0x00, 0x00, 0x01, 0x50, 0xa9, 0x2b, 0xb1, 0x21, 0x2c, 0xd0, 0x05, 0x16, 0xb6, 0x5f,
                0xde, 0x07, 0x04, 0x61, 0x47, 0x60, 0x00, 0x09, 0x63, 0x87, 0x4f, 0xcb, 0xb1, 0x1e,
                0xaa, 0x73, 0x4e, 0xe8, 0x78, 0x09, 0x00, 0x01, 0x7f, 0x80, 0xff,
            ]
        );
